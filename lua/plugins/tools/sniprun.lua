return {
	...
	config = function()
		...
		vim.api.nvim_set_hl(0, "SniprunVirtualTextOk", { bg = "#66eeff", fg = "#000000", ctermbg = "Cyan", ctermfg = "Black" })
		vim.api.nvim_set_hl(0, "SniprunFloatingWinOk", { fg = "#66eeff", ctermfg = "Cyan" })
		vim.api.nvim_set_hl(0, "SniprunVirtualTextErr", { bg = "#881515", fg = "#000000", ctermbg = "DarkRed", ctermfg = "Black" })
