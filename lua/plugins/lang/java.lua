...
return {
	specs = { gh("mfussenegger/nvim-jdtls") },
	setup = function()
		...
		local function get_jdtls_config()
			...
			local config = {
				...
				on_attach = function(_, bufnr)
					...
					vim.keymap.set("n", "<localleader>jo", jdtls.organize_imports, { desc = "Organize Imports", buffer = bufnr })
					vim.keymap.set("n", "<localleader>jv", jdtls.extract_variable, { desc = "Extract Variable", buffer = bufnr })
					vim.keymap.set("n", "<leader>jc", jdtls.extract_constant, { desc = "Extract Constant", buffer = bufnr })
					vim.keymap.set("v", "<localleader>jm", [[<ESC><CMD>lua require('jdtls').extract_method(true)<CR>]], { desc = "Extract Method", buffer = bufnr })
					vim.keymap.set("n", "<leader>jt", jdtls.test_class, { desc = "Test Class", buffer = bufnr })
					vim.keymap.set("n", "<localleader>jn", jdtls.test_nearest_method, { desc = "Test Nearest Method", buffer = bufnr })
				end,
			}
