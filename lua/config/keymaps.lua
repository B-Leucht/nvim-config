...
-- Oil.nvim (if using as replacement)
...
-- ===============================================
-- LSPSAGA KEYMAPS (YOUR PREFERRED MAPPINGS)
-- ===============================================
...
keymap("n", "<leader>lo", "<cmd>VimtexCompileOutput<CR>", opts)
keymap("n", "<leader>lg", "<cmd>VimtexStatus<CR>", opts)
keymap("n", "<leader>lG", "<cmd>VimtexStatusAll<CR>", opts)
...
if which_key_ok then
	which_key.register({
		...
		["<leader>c"] = { name = "+code/compiler" },
		["<leader>w"] = { name = "+workspace" },
		["<leader>x"] = { name = "+diagnostics" },
		["<leader>a"] = { name = "+ai/avante" },
		["<leader>s"] = { name = "+saga/show" },
	})
end
